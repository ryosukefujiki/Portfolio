...
<div class='TheTransition TheLineandballTransition'>
  <div class='TheTransition_Background TheLineandball_Background' ref='background'></div>
  <div class='TheTransition_Background TheLineandball_Background' ref='background'></div>
    <div class='TheTransition_Background TheLineandball_Background' ref='background'>
  ...
  methods: { // アニメーションの宣言はここ
    enter () { // `entered`が`true`になったとき発火
      requestAnimationFrame(() => {
        TweenMax.staggerTo(".TheLineandball_Background", 0.55, {
          x: '0%',
          ease: Expo.easeOut
        },0.04)
      })
    ...
    async set (){
      requestAnimationFrame(() => {
        TweenMax.staggerTo(".TheLineandball_Background", 0, {
          opacity: '0%',
          ease: Expo.easeOut
        },0.04)
      })
