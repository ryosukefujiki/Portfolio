<template>
    <div class="TheHome_Work">
            <a @click="click">
                ...
                <p class="TheHome_WorkCategory" :style="headingStyle">Game Design</p>
                <p class="TheHome_WorkTitle" :style="textStyle">LINE and BALL</p>
            </a>
        </div>
</template>
