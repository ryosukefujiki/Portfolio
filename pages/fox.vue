  ...
  <div class="TheWork" v-scroll="handleScroll">
    <div class="TheWork_HeroImg FoxImg">
      ...
      <h1 class="TheWork_HeroHeading TheWork_Title">
        <span class="TheWork_TitleText">Fuzzy Order eXperience</span>
        <span class="TheWork_HeroNumberBg"></span>
      </h1>
      <p class="TheWork_HeroCategory TheWork_Title">
        <span class="TheWork_TitleText">Hardware / UX Design</span>
        <span class="TheWork_HeroNumberBg"></span>
      </p>
    ...
    <section class="TheWork_Contents">
        ...
        <div class="TheWork_Overview_RightSide">
          ...
          <div class="Content_Team TheWork_Section">
            ...
            <p class="Overview_Text">藤木 良祐
              ...
              <br>斎藤 モンド
              <br>
              <span class="Overview_Text__task">- Hardware</span>
            </p>
          </div>
        </div>
      ...
      <div class="TheWork_Content TheWork_Process TheWork_Section">
        <div class="Content_Process">
          ...
          <p
            class="Content_Text"
          >Makeblockを利用し、人間の曖昧な表現（手のジェスチャー）だけで,わたあめの色と大きさをオーダーし、コンピューターが作ることができるシステムを開発した。人間同士では成り立つ「これくらいの大きさのものが欲しい」や「こんな感じの色味が欲しい」といった曖昧な表現を人間とコンピュータの間でも行える知覚的インターフェースを制作した。今後、画像認識やファブリケーションの技術が向上し、曖昧な表現で機械とインタラクションをする機会が増えていくだろう。</p>
      ...
      <div class="TheWork_Content TheWork_Contents TheWork_Section">
        <div class="Content_Process">
          ...
          <div class="Image_Container">
            <img :src="development01Img" alt class="TheWork_Img TheWork_Img_Small">
            <img :src="development02Img" alt class="TheWork_Img TheWork_Img_Small">
            <img :src="development03Img" alt class="TheWork_Img TheWork_Img_Small">
            <img :src="development04Img" alt class="TheWork_Img TheWork_Img_Small">
          </div>
        </div>
      </div>
...
export default {
  ...
  head() {
    return {
      title: "FOX",
      meta: [
        { property: "og:title", content: "FOX | Ryosuke Fujiki Portfolio" },
        { property: "og:url", content: "https://ryosukefujiki.design/fox" },
        {
          property: "twitter:title",
          content: "FOX | Ryosuke Fujiki Portfolio"
        }
      ]
    };
  },
