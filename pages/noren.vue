  ...
  <div class="TheWork" v-scroll="handleScroll">
    <div class="TheWork_HeroImg NorenImg">
      ...
      <h1 class="TheWork_HeroHeading TheWork_Title">
        <span class="TheWork_TitleText">のれんさま</span>
        <span class="TheWork_HeroNumberBg"></span>
      </h1>
      <p class="TheWork_HeroCategory TheWork_Title">
        <span class="TheWork_TitleText">Software / Planning</span>
        <span class="TheWork_HeroNumberBg"></span>
      </p>
        ...
        <div class="TheWork_Overview_RightSide">
          ...
          <div class="Content_Team TheWork_Section">
            ...
            <p class="Overview_Text">藤木
              ...
              <br>高橋
              <br>
              <span class="Overview_Text__task">- Planner</span>
            </p>
          </div>
        </div>
...
export default {
  ...
  head() {
    return {
      title: "Noren",
      meta: [
        { property: "og:title", content: "Noren | Ryosuke Fujiki Portfolio" },
        { property: "og:url", content: "https://ryosukefujiki.design/noren" },
        {
          property: "twitter:title",
          content: "Noren | Ryosuke Fujiki Portfolio"
        }
      ]
    };
  },
