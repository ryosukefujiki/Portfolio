<template>
  <div class="TheWork" v-scroll="handleScroll">
    <div class="TheWork_HeroImg HiveImg">
      ...
      <h1 class="TheWork_HeroHeading TheWork_Title"><span class="TheWork_TitleText">Hive</span><span class="TheWork_HeroNumberBg"></span></h1>
      <p class="TheWork_HeroCategory TheWork_Title"><span class="TheWork_TitleText">Logo Design / UI Design / UX Design</span><span class="TheWork_HeroNumberBg"></span></p>
    ...
    <section class="TheWork_Contents">
        ...
        <div class="TheWork_Overview_RightSide">
          ...
          <div class="Content_Team TheWork_Section">
            ...
            <p class="Overview_Text">藤木 良祐
              ...
              児玉 彩
              <br>
              <span class="Overview_Text__task">- Project Management</span>
              <br>
              塩浜 有紀子
              <br><span class="Overview_Text__task">- UI Design</span>
            </p>
          </div>
        </div>
      ...
      <div class="TheWork_Content TheWork_Process TheWork_Section">
            <div class="Content_Process">
                ...
                <p class="Content_Text">チームメンバーとのアイディエーションによって、「長い付き合いのある特別な 2 人は信頼関係が あり今後の関係性において大きな変化より安定を求めている」という仮説を導き出しました。この仮定検証を行うために、想定するユーザー像に近い男女合わせて 10 名にユーザーインタビューを行いました。そうしたの過程の中で、長い付き合いのある特別な2人は大きな変化より 安定を求めていることがわかり、またいくつかの不満を持っていることに気がつきました。</p>
        ...
        <div class="TheWork_Content TheWork_Contents TheWork_Section">
            <div class="Content_Process">
                ...
                <p class="Content_Text">度重ねたユーザーインタビューの過程の中で、信頼関係のある特別な 2人は Between や Slack などの Closed なメッセージアプリケーションを用いてコミュニケーションをとってることがわかりました。そこで、そうした Closed なメッセージアプリにおけるコミュニケーションで生じるペインとゴールを導き出し、ペルソナ、ユーザーストーリーを作成しました。</p>

                <div class="Image_Container">
                    <img :src="persona01Img" alt="" class="TheWork_Img TheWork_Img_Small ">
                    <img :src="persona02Img" alt="" class="TheWork_Img TheWork_Img_Small  ">
                    <img :src="persona03Img" alt="" class="TheWork_Img TheWork_Img_Small ">
                    <img :src="persona04Img" alt="" class="TheWork_Img TheWork_Img_Small  ">
                </div>
            </div>
        </div>
        <div class="TheWork_Content TheWork_Research TheWork_Section">
            <div class="Content_Process">
                ...
                <p class="Content_Text">Hive は、まず2人だけのコミュニケーションスペースを提供します。自らチャットルームを作成 し、日々の思い出や目的ごとに分けたコミュニケーションをすることができます。次に、Hive で は、Bot を活用し、2 人だけのコミュニケーションをより快適なものにすべくサポートします。</p>

                <!-- <div class="Image_Container ">
                    <img :src="process01Img" alt="" class="TheWork_Img TheWork_Img_Small">
                </div> -->
                <img :src="contentsImg" alt class="TheWork_Img TheWork_Img_Big TheWork_Section">
...
export default {
    ...
    return {
      scrollY: 0,
      targetY: 0,
      homeImg: '/hive/hive_old.png',
      process01Img: '/hive/process01.png',
      process02Img: '/hive/process02.png',
    //   home2Img: '/playfulfes/playfulfes2.png',
      persona01Img: '/hive/persona01.png',
